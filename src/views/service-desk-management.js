...
const ServiceDeskManagement = () => {
  return (
    <div className={styles.container}>
      ...
      <div id="cs2-role" className={styles.container04}>
      ...
      <div id="cs2-problem" className={styles.div2}>
      ...
      <div id="cs2-deadline" className={styles.container07}>
        <div className={styles.container08}>
          ...
          <h1 className={` ${projectStyles.thqHeading1} ${styles.text15} `}>Timeline:</h1>
          <span className={styles.text16}>~ 10 weeks</span>
        </div>
      </div>
      <div id="cs2-process" className={styles.container09}>
      ...
      <div id="cs2-comp-analysis-pic" className={styles.container12}>
        <img
      ...
      <div id="cs1-ia-desc" className={styles.container13}>
      ...
      <div id="cs2-roles" className={styles.div3}>
      ...
      <div id="cs2-userflows" className={styles.container17}>
      ...
      <div id="cs2-user-flows-pic" className={styles.container18}>
        <img
      ...
      <div id="cs2-ia-desc" className={styles.container20}>
      ...
      <div id="cs2-user-flows-pic" className={styles.container21}>
        <img
      ...
      <div id="cs2-branding" className={styles.container23}>
      ...
      <div id="cs2-solution" className={styles.container24}>
      ...
      <div id="cs2-sol-home-pic" className={styles.container28}>
        <img
      ...
      <div id="cs2-sol-pool" className={styles.container29}>
      ...
      <div id="cs2-sol-pool-pic" className={styles.container31}>
        <img
      ...
      <div id="cs2-sol-pool" className={styles.container32}>
      ...
      <div id="cs2-sol-ticket-pic" className={styles.container34}>
        <img
      ...
      <div id="cs2-sol-manager" className={styles.container35}>
      ...
      <div id="cs2-sol-ticket-pic" className={styles.container37}>
        <img
      ...
      <div id="cs2-final thoughts" className={styles.container38}>
