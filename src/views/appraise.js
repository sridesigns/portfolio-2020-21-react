...
const Appraise = () => {
  return (
    <div className={styles.container}>
      ...
      <div id="cs3-role" className={styles.container04}>
      ...
      <div id="cs3-problem" className={styles.div02}>
        ...
        <span className={styles.text013}>
          ...
          <span className={styles.text014}>past 7+ years</span>. Although the application had
      ...
      <div id="cs3-deadline" className={styles.container07}>
        <div className={styles.container08}>
          ...
          <h1 className={` ${projectStyles.thqHeading1} ${styles.text019} `}>Timeline:</h1>
          <span className={styles.text020}>~ 12 months</span>
        </div>
      </div>
      <div id="cs3-existing-process" className={styles.container09}>
        ...
        <div id="cs3-roles" className={styles.div03}>
          <div id="persona-1" className={styles.container11}>
          ...
          <div id="persona-1" className={styles.container12}>
        ...
        <div className={styles.container14}>
          <span className={styles.text025}>
            ...
            <br />-<span className={styles.text026}> Annual evaluation</span>
            (Conducted at the end of each year)
            <br />-<span className={styles.text027}>Project Closure</span>( Conducted if a employee
      ...
      <div id="cs3-kickoff" className={styles.container15}>
        <h1 className={` ${projectStyles.thqHeading1} ${styles.text032} `}>
          <span className={styles.text033}>Kick Off</span>
        </h1>
        ...
        <h1 className={` ${projectStyles.thqHeading1} ${styles.text035} `}>
          <span data-type="span" className={styles.text036}>
            MY ROLE
          </span>
        </h1>
        ...
        <span className={styles.text039}>
          ...
          <span className={styles.text040}>ReactJS</span>
          and
          <span className={styles.text041}>Java</span>. I started working on the designs in Sketch
          but we migrated to
          <span className={styles.text042}>Figma</span>
          which made collaboration, reviews much quicker and easier.
        </span>
      </div>
      <div id="cs3-unde" className={styles.div04}>
        <h1 className={` ${projectStyles.thqHeading1} ${styles.text043} `}>
        ...
        <span className={styles.text046}>
          I interviewed
          <span className={styles.text047}>12 users</span>
          and conducted
          <span className={styles.text048}>3 focus group sessions</span>
      ...
      <div id="cs3-user-flows" className={styles.div05}>
        <h1 className={` ${projectStyles.thqHeading1} ${styles.text050} `}>
        ...
        <span className={styles.text052}>
          ...
          <span className={styles.text053}>8 personas</span>
        ...
        <span className={styles.text055}>
          The below
          <span className={styles.text056}>3 critical user journeys</span>
      ...
      <div id="cs3-howitstarted" className={styles.container16}>
        <h1 className={` ${projectStyles.thqHeading1} ${styles.text057} `}>
      ...
      <div id="cs3-ia" className={styles.div06}>
        <h1 className={` ${projectStyles.thqHeading1} ${styles.text062} `}>
          <span data-type="span" className={styles.text063}>
            Information Architecture
          </span>
        </h1>
      ...
      <div id="cs3-appraisee-flow" className={styles.div07}>
        <h1 className={` ${projectStyles.thqHeading1} ${styles.text067} `}>
          <span data-type="span" className={styles.text068}>
            Solution
          </span>
        </h1>
        <h1 className={` ${projectStyles.thqHeading1} ${styles.text069} `}>
          <span className={styles.text070}>APPRAISEE FLOW</span>
        </h1>
      ...
      <div id="cs3-evaluator-flow" className={styles.div08}>
        <h1 className={` ${projectStyles.thqHeading1} ${styles.text075} `}>
          <span data-type="span" className={styles.text076}>
      ...
      <div id="cs3-evaluator-pic" className={styles.container17}>
        <div id="cs1-ebooks-pic" className={styles.container18}>
          <img
        ...
        <span className={styles.text080}>Snippet of projects &amp; placements</span>
      </div>
      <div id="cs3-reminder" className={styles.div09}>
      ...
      <div id="cs3-mobile" className={styles.container19}>
        ...
        <span className={styles.text085}>
          ...
          goals, record progress and have a conversation with their evaluators/reviewers as needed.
        </span>
      ...
      <div id="cs3-weblaunch" className={styles.container20}>
        ...
        <span className={styles.text087}>
          ...
          <span className={styles.text088}>16 months.</span>
        ...
        <span className={styles.text092}>
          ...
          interface.Â We had ~<span className={styles.text093}>100k logins</span>
          in the first week but as expected the traffic gradually reduced in the weeks after launch.
        </span>
      </div>
      <div id="cs3-moblaunch" className={styles.container21}>
        ...
        <span className={styles.text096}>
          <span data-type="span">
            <span className={styles.text098}>
              ...
              security testing,
              <span className={styles.text099}>we launched the mobile app on April 30, 2019.</span>
            </span>
          </span>
        </span>
        <span className={styles.text100}>
          The response was mostly positive and people loved the app performance and the new
          interface.Â We had ~<span className={styles.text101}>100k logins</span>
          in the first week but as expected the traffic gradually reduced in the weeks after launch.
        </span>
        ...
        <span className={styles.text103}>
          ...
          continuously working on improving the app with bug fixes, new features in regular sprints
        </span>
      </div>
      <div id="cs3-learnings" className={styles.container22}>
      ...
      <div id="cs1-insights" className={styles.container23}>
        <h1 className={` ${projectStyles.thqHeading1} ${styles.h109} `}>
          <span data-type="span">Thank you for reading! ð</span>
        </h1>
        <div id="persona-1" className={styles.container24}></div>
      </div>
      <div id="footer" className={styles.container25}>
        <div className={styles.container26}>
          <div className={styles.container27}>
            <span className={styles.text108}>
              Let&apos;s connect. Feel free to drop a
              <span className={styles.text109}>&quot;hello&quot;</span>
              anytime
            </span>
          </div>
          <div className={styles.container28}>
            ...
            >
              <svg
                viewBox="0 0 877.7142857142857 1024"
                className={` ${projectStyles.thqIcon} ${projectStyles.thqLink} ${styles.icon6} `}
              >
