...
const LearningHub = () => {
  return (
    <div className={styles.container}>
      ...
      <div id="cs1-role" className={styles.container04}>
      ...
      <div id="cs1-preview" className={styles.container07}>
      ...
      <div id="cs1-deadline" className={styles.container09}>
        <div className={styles.container10}>
          ...
          <h1 className={` ${projectStyles.thqHeading1} ${styles.text18} `}>Timeline:</h1>
          <span className={styles.text19}>~ 8 weeks</span>
        </div>
      </div>
      <div id="cs1-process" className={styles.container11}>
      ...
      <div id="cs1-existingia-pic" className={styles.container14}>
        <img
      ...
      <div id="cs1-ia-desc" className={styles.container15}>
      ...
      <div id="cs1-revisedia-pic" className={styles.container16}>
        <img
      ...
      <div id="cs1-persona-desc" className={styles.container17}>
      ...
      <div id="cs1-personas" className={styles.container18}>
      ...
      <div id="cs1-userflows-desc" className={styles.container21}>
      ...
      <div id="cs1-wf-pic" className={styles.container22}>
        <img
      ...
      <div id="cs1-sol" className={styles.container23}>
      ...
      <div id="cs1-gr-descid" className={styles.container24}>
      ...
      <div id="cs1-home-pic" className={styles.container25}>
        <img
      ...
      <div id="cs1-academics" className={styles.container26}>
      ...
      <div id="cs1-academy-pic" className={styles.container27}>
      ...
      <div id="cs1-ebooks" className={styles.container29}>
      ...
      <div id="cs1-ebook-pic" className={styles.container30}>
        <div id="cs1-ebooks-pic" className={styles.container31}>
          <img
      ...
      <div id="cs1-ebooks" className={styles.container32}>
      ...
      <div id="cs1-ebook-pic" className={styles.container33}>
        <div id="cs1-ebooks-pic" className={styles.container34}>
          <img
      ...
      <div id="cs1-insights" className={styles.container35}>
        <h1 className={` ${projectStyles.thqHeading1} ${styles.h107} `}>
          <span data-type="span">Some Insights...</span>
        </h1>
        <div id="persona-1" className={styles.container36}>
      ...
      <div id="cs1-movingon" className={styles.container39}>
      ...
      <div id="cs1-insights" className={styles.container40}>
        <h1 className={` ${projectStyles.thqHeading1} ${styles.h112} `}>
          <span data-type="span">Thank you for reading! ð</span>
        </h1>
        <div id="persona-1" className={styles.container41}></div>
      </div>
      <div id="footer" className={styles.container42}>
