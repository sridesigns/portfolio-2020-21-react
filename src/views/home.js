...
const Home = () => {
  return (
    <div className={styles.home}>
        ...
        <div className={styles.container18}>
          ...
          <Link to="/service-desk-management" className={styles.navlink5}>
            <div className={` ${projectStyles.thqLink} ${styles.container19} `}>
              ...
              <svg
                viewBox="0 0 1024 1024"
                className={` ${projectStyles.thqIcon} ${styles.icon06} `}
              >
                <title>arrow-right</title>
                <path d="M481.835 243.499l225.835 225.835h-494.336c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667h494.336l-225.835 225.835c-16.683 16.683-16.683 43.691 0 60.331s43.691 16.683 60.331 0l298.667-298.667c3.925-3.925 7.083-8.619 9.259-13.824 4.309-10.453 4.309-22.229 0-32.683-2.091-5.035-5.163-9.728-9.259-13.824l-298.667-298.667c-16.683-16.683-43.691-16.683-60.331 0s-16.683 43.691 0 60.331z"></path>
              </svg>
      ...
      <div id="footer" className={styles.container20}>
        <div className={styles.div2}>
          ...
          <div className={styles.container22}>
            ...
            >
              <svg
                viewBox="0 0 877.7142857142857 1024"
                className={` ${projectStyles.thqIcon} ${projectStyles.thqLink} ${styles.icon11} `}
              >
